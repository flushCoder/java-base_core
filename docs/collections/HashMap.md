...
此链接是[基于JDK1.8的HashMap](https://github.com/flushCoder/java-base_core/tree/master/docs/collections/HashMap8.md)  

![]()

如图所示，HashMap是基于 Entry<K,V> 数组和 Entry<K,V> 单向链表实现的，是线程不安全的。  
[实现简单的HashMap](https://github.com/flushCoder/java-base_core/blob/master/src/main/java/com/cx/collections/hashmap/MyHashMap.java)  
其中参数为：
