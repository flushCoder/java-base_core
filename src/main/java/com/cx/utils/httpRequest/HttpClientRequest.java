 ...
 * 
 * @see 本工具所采用的是HttpComponents-Client-4.5.3
 * @see ========================================================================
 *      == =========================
...
public class HttpClientRequest {
    ...
    public static String sendPostSSLRequest(String url, String body ,String charset,String mimeType){
        ...
        try {
            ...
            if (url.startsWith("https")) {
                ...
                // 执行 Http 请求.
                client = HttpClientRequest.client;
                res = client.execute(post);
            }
    ...
    public static void main(String[] args) throws Exception {
        ...
        for(int i = 1;i<len;i++){
            String url = "http://localhost:9090/api/qianlong/receiveLoanResult";
            Map<String, String> map = new HashMap<>();
            map.put("sign","qwe");
            map.put("data","qwe");
            String result = postParameters(url, JSON.toJSONString(map));
